...
(0, globals_1.describe)("extractSpotifyRating", () => {
    ...
    test("extracts content from span within larger HTML", () => __awaiter(void 0, void 0, void 0, function* () {
        const html = yield (0, utils_1.fetchHydratedHtmlContentDirect)("https://open.spotify.com/show/2BAjN7DBH8Kr90QRrUv8tM", (page) => __awaiter(void 0, void 0, void 0, function* () {
